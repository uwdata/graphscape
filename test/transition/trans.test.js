...
describe('transition.trans', function () {
    describe('mark edit operation', function () {
        it('should return a mark edit operation correctly.', function () {
            var tr = trans.markEditOps(startVL, destinationVL, editOpSet.DEFAULT_EDIT_OPS["markEditOps"])[0];
    ...
    describe('transform edit operation', function () {
        var result = trans.transformEditOps(startVL, destinationVL, editOpSet.DEFAULT_EDIT_OPS["transformEditOps"]);
        it('should return SCALE,AGGREGATE, and SORT editOperations correctly.', function () {
            var scaleTrs = trans.transformBasic(startVL, destinationVL, "y", "SCALE", editOpSet.DEFAULT_EDIT_OPS["transformEditOps"]);
